...
Vec3F Mersenne::randV3()
{
    // range: 0 to 1
    return Vec3F( float(randI())/ I32_MAX,
                      float(randI())/ I32_MAX,
                      float(randI())/ I32_MAX );
}
Vec3F Mersenne::randV3(float vmin, float vmax)
{
...
Vec3F Mersenne::randV3(Vec3F vmin, Vec3F vmax)
{
...
Vec4F Mersenne::randV4(float vmin, float vmax)
{
    return Vec4F(vmin + float(randI() * (vmax - vmin)) / I32_MAX,
                    vmin + float(randI() * (vmax - vmin)) / I32_MAX,
                    vmin + float(randI() * (vmax - vmin)) / I32_MAX,
                    vmin + float(randI() * (vmax - vmin)) / I32_MAX);
}
Vec4F Mersenne::randV4(Vec4F vmin, Vec4F vmax)
{
    return Vec4F(vmin.x + float(randI() * (vmax.x - vmin.x)) / I32_MAX,
